...
BEGIN
    ...
    IF p_nombres IS NULL OR p_apellidos IS NULL OR p_contraseña IS NULL
    ...
    INSERT INTO usuario (nombres_usuario, apellidos_usuario, contraseña_usuario,
                         documento_usuario, correo_usuario, telefono_usuario,
                         tipo_usuario, estado_usuario, fecha_usuario)
    VALUES (p_nombres, p_apellidos, p_contraseña, p_documento, p_correo,

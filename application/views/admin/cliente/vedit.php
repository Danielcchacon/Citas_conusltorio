                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url(); ?>mantenimiento/ccliente/cupdate" method="POST">
                            <input type="hidden" value="<?php echo $clienteedit->idcliente ?>" id="txtidcliente"
                                name="txtidcliente">
                            ...
                            <div class="form-group <?php echo !empty(form_error('txtcodigo')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" id="txtcodigo" name="txtcodigo" class="form-control"
                                    value="<?php echo !empty(form_error('txtcodigo')) ? set_value('txtcodigo') : $clienteedit->codigo ?>"
                                    onblur="this.value=this.value.toUpperCase();">
                                <?php echo form_error('txtcodigo', '<span class="help-block">', '</span>') ?>
                            </div>
                            <div
                                class="form-group <?php echo !empty(form_error('txttipo_cliente')) ? 'has-erro' : ''; ?>">
                            ...
                            <div class="form-group <?php echo !empty(form_error('txtnombre')) ? 'has-erro' : ''; ?>">
                                ...
                                <input type="text" id="txtnombre" name="txtnombre" class="form-control"
                                    value="<?php echo $clienteedit->nombre ?>"
                                    onblur="this.value=this.value.toUpperCase();">
                            </div>
                            <div class="form-group <?php echo !empty(form_error('txtdireccion')) ? 'has-erro' : ''; ?>">
                                ...
                                <input type="text" id="txtdireccion" name="txtdireccion" class="form-control"
                                    value="<?php echo $clienteedit->direccion ?>"
                                    onblur="this.value=this.value.toUpperCase();">
                            </div>
                            <div class="form-group <?php echo !empty(form_error('txttelefono')) ? 'has-erro' : ''; ?>">
                                <label for="telefono">Telefono</label>
                                <input type="text" id="txttelefono" name="txttelefono" class="form-control"
                                    value="<?php echo $clienteedit->telefono ?>"
                                    onblur="this.value=this.value.toUpperCase();">
                            </div>
                            <div
                                class="form-group <?php echo ($clienteedit->estado == 1) ? "has-success" : "has-error"; ?>">
                                <label for="estado">Estado</label>
                                <select name="txtestado" id="txtestado" class="form-control" required>
                                    <option value="1" <?php if ($clienteedit->estado == 1)
                                        echo 'selected'; ?>>Activo
                                    </option>
                                    <option value="2" <?php if ($clienteedit->estado == 2)

    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url(); ?>mantenimiento/ctipo_material/cadd"
                            class="btn btn-primary btn-flat"> <span class="fa fa-plus"></span>  Agregar Tipo Material</a>
                    </div>
                </div>
<hr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="table" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if (!empty($tipo_materialindex)): ?>
                                <?php foreach ($tipo_materialindex as $atributos): ?>
                                    <tr>
                                        <td>
                                            <?php echo $atributos->idtipo_material; ?>
                                        </td>
                                        <td>
                                        ...
                                        ?> 
                                       <?php $data = $atributos->idtipo_material."*" .$atributos->nombre."*".$atributos->descripcion; ?> 
                                        <td>
                                            <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-info btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo $data; ?>">
                                                ...
                                                <a href="<?php echo base_url(); ?>mantenimiento/ctipo_material/cedit/<?php echo $atributos->idtipo_material; ?>"
                                                    class="btn btn-warning">
                                                    <span class="fa fa-pencil"></span>
                                                </a>

                                                <a href="<?php echo base_url(); ?>mantenimiento/ctipo_material/cdelete/<?php echo $atributos->idtipo_material; ?>"

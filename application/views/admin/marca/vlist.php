    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url(); ?>mantenimiento/cmarca/cadd"
                            class="btn btn-primary btn-flat"> <span class="fa fa-plus"></span>  Agregar marca</a>
                    </div>
                </div>
<hr>
                            ...
                            <?php if (!empty($marcaindex)): ?>
                                <?php foreach ($marcaindex as $atributos): ?>
                                    <tr>
                                        ...
                                        ?> 
                                       <?php $data = $atributos->idmarca."*" .$atributos->nombre."*".$atributos->descripcion; ?> 
                                        <td>
                                            <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-info btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo $data; ?>">
                                                ...
                                                <a href="<?php echo base_url(); ?>mantenimiento/cmarca/cedit/<?php echo $atributos->idmarca; ?>"
                                                    class="btn btn-warning">
                                                    <span class="fa fa-pencil"></span>
                                                </a>

                                                <a href="<?php echo base_url(); ?>mantenimiento/cmarca/cdelete/<?php echo $atributos->idmarca; ?>"

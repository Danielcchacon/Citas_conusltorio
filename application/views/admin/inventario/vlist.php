    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url(); ?>mantenimiento/cinventario/cadd"
                            class="btn btn-primary btn-flat"> <span class="fa fa-plus"></span>  Agregar inventario</a>
                    </div>
                </div>
<hr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="table" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if (!empty($inventarioindex)): ?>
                                <?php foreach ($inventarioindex as $atributos): ?>
                                    <tr>
                                        <td>
                                            <?php echo $atributos->idinventario; ?>
                                        </td>
                                        <td>
                                        ...
                                        ?> 
                                       <?php $data = $atributos->idinventario."*" .$atributos->nombre."*".$atributos->descripcion; ?> 
                                        <td>
                                            <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-info btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo $data; ?>">
                                                ...
                                                <a href="<?php echo base_url(); ?>mantenimiento/cinventario/cedit/<?php echo $atributos->idinventario; ?>"
                                                    class="btn btn-warning">
                                                    <span class="fa fa-pencil"></span>
                                                </a>

                                                <a href="<?php echo base_url(); ?>mantenimiento/cinventario/cdelete/<?php echo $atributos->idinventario; ?>"

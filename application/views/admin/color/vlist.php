    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url(); ?>mantenimiento/ccolor/cadd"
                            class="btn btn-primary btn-flat"> <span class="fa fa-plus"></span>  Agregar color</a>
                    </div>
                </div>
<hr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="table" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if (!empty($colorindex)): ?>
                                <?php foreach ($colorindex as $atributos): ?>
                                    <tr>
                                        <td>
                                            <?php echo $atributos->idcolor; ?>
                                        </td>
                                        <td>
                                        ...
                                        ?> 
                                       <?php $data = $atributos->idcolor."*" .$atributos->nombre."*".$atributos->descripcion; ?> 
                                        <td>
                                            <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-info btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo $data; ?>">
                                                ...
                                                <a href="<?php echo base_url(); ?>mantenimiento/ccolor/cedit/<?php echo $atributos->idcolor; ?>"
                                                    class="btn btn-warning">
                                                    <span class="fa fa-pencil"></span>
                                                </a>

                                                <a href="<?php echo base_url(); ?>mantenimiento/ccolor/cdelete/<?php echo $atributos->idcolor; ?>"

    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url(); ?>mantenimiento/ctipo_cliente/cadd"
                            class="btn btn-primary btn-flat"><span class="fa fa-plus"></span> Agregar Tipo de Persona</a>
                    </div>
                </div>
<hr>
                        ...
                        <tbody>
                            <?php if (!empty($tipo_clienteindex)): ?>
                                <?php foreach ($tipo_clienteindex as $atributos): ?>
                                    <tr>
                                        <td>
                                            <?php echo $atributos->idtipo_cliente; ?>
                                        </td>
                                        <td>
                                        ...
                                        ?> 
                                       <?php $data = $atributos->idtipo_cliente."*" .$atributos->nombre. "*".$atributos->descripcion; ?> 
                                        <td>
                                            <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-info btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo $data; ?>">
                                                ...
                                                <a href="<?php echo base_url(); ?>mantenimiento/ctipo_cliente/cedit/<?php echo $atributos->idtipo_cliente; ?>"
                                                    class="btn btn-warning">
                                                    <span class="fa fa-pencil"></span>
                                                </a>

                                                <a href="<?php echo base_url(); ?>mantenimiento/ctipo_cliente/cdelete/<?php echo $atributos->idtipo_cliente; ?>"

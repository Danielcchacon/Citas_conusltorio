                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url(); ?>mantenimiento/cusuarios/cupdate" method="POST">
                            <input type="hidden" value="<?php echo $usuariosedit->usuarios_id ?>" id="txtidusuarios" name="txtidusuarios">


                            <div class="form-group <?php echo !empty(form_error('txtnombre')) ? 'is-invalid' : ''; ?>">
                                <label for="txtnombre">Nombre </label>
                                <input type="text" id="txtnombre" name="txtnombre" class="form-control"
                                    value="<?php echo !empty(form_error('txtnombre')) ? set_value('txtnombre') : $usuariosedit->nombres_usuarios ?>"
                            ...
                            <div class="form-group <?php echo !empty(form_error('txtapellido')) ? 'is-invalid' : ''; ?>">
                                ...
                                <input type="text" id="txtapellido" name="txtapellido" class="form-control"
                                    value="<?php echo !empty(form_error('txtapellido')) ? set_value('txtapellido') : $usuariosedit->apellidos_usuarios ?>"
                                    onblur="this.value=this.value.toUpperCase();">
                            ...
                            <div class="form-group <?php echo !empty(form_error('txtdocumento')) ? 'is-invalid' : ''; ?>">
                                ...
                                <input type="text" id="txtdocumento" name="txtdocumento" class="form-control"
                                    value="<?php echo !empty(form_error('txtdocumento')) ? set_value('txtdocumento') : $usuariosedit->documento_usuarios ?>"
                                    onblur="this.value=this.value.toUpperCase();">
                            ...
                            <div class="form-group <?php echo !empty(form_error('txttelefono')) ? 'is-invalid' : ''; ?>">
                                ...
                                <input type="text" id="txttelefono" name="txttelefono" class="form-control"
                                    value="<?php echo !empty(form_error('txttelefono')) ? set_value('txttelefono') : $usuariosedit->telefono_usuarios ?>"
                                    onblur="this.value=this.value.toUpperCase();">
                            ...
                            <div class="form-group <?php echo !empty(form_error('txteps')) ? 'has-erro' : ''; ?>">
                                ...
                                <select name="txteps" id="txteps" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    <?php foreach ($eps_usuarioscombo as $atributos): ?>
                                        <?php if($atributos->eps_id == $usuariosedit->eps_usuarios): ?>
                            ...
                            <div class="form-group <?php echo !empty(form_error('txtregimen')) ? 'has-erro' : ''; ?>">
                                ...
                                <select name="txtregimen" id="txtregimen" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    <?php foreach ($tipo_regimencombo as $atributos): ?>
                                        <?php if($atributos->tipo_regimen_id == $usuariosedit->tipo_usuarios): ?>
